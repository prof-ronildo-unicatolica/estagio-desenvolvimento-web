export default function ImageAndCarousel() {
  return (
    <section className="mb-5" id="image-carousel">
      <h2 className="text-secondary mb-4 fs-4">4. Componentes Basicos: Carrossel e Imagem</h2>
      <div className="row g-4">
        {/* Image demonstration */}
        <div className="col-md-6">
          <div className="card h-100 shadow-sm border-0">
            <div className="card-header bg-dark text-white fw-bold">Imagem Estatica do Projeto</div>
            <div className="card-body d-flex flex-column justify-content-between">
              <p className="text-muted small">Demonstracao de renderizacao de imagem estatica aleatoria do Picsum Photos.</p>
              <img 
                src="https://picsum.photos/600/300?random=1" 
                alt="Placeholder Aleatorio" 
                className="img-fluid rounded border shadow-sm mb-3"
              />
              <div className="small text-muted text-center">Imagem aleatoria recarregada dinamicamente</div>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6">
          <div className="card h-100 shadow-sm border-0">
            ...
            <div className="card-body d-flex flex-column justify-content-between">
              <p className="text-muted small">Componente de carrossel com fotos aleatorias nativo do Bootstrap 5.</p>
                ...
                <div className="carousel-inner" style={{ height: '220px' }}>
                  <div className="carousel-item active h-100">
                    ...
                    <div className="carousel-caption d-block">
                      <h5>FastAPI</h5>
                      <p className="small">APIs modernas e rapidas com Python.</p>
                    </div>
                  </div>
                  <div className="carousel-item h-100">
                    ...
                    <div className="carousel-caption d-block">
                      <h5>React & Vite</h5>
                      <p className="small">Interfaces rapidas e reativas.</p>
                    </div>
                  </div>
                  <div className="carousel-item h-100">
                    <img 
                    ...
                    <div className="carousel-caption d-block">
                      ...
                      <p className="small">Persistencia relacional e NoSQL robusta.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="small text-muted text-center mt-3">Carrossel de Slides com controles interativos</div>
            </div>
          </div>
        </div>
      </div>
